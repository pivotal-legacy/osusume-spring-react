...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcRestaurantList = __webpack_require__(1);
	
	var _srcRestaurantList2 = _interopRequireDefault(_srcRestaurantList);
	...
	var _reactAddonsTestUtils = __webpack_require__(161);
	
	var _reactAddonsTestUtils2 = _interopRequireDefault(_reactAddonsTestUtils);
	
	var _srcRestaurantRepository = __webpack_require__(159);
	
	var _srcRestaurantRepository2 = _interopRequireDefault(_srcRestaurantRepository);
	
	describe('RestaurantList component', function () {
	    var renderedRestaurantList = undefined;
	
	    afterEach(function () {
	        _reactDom2['default'].unmountComponentAtNode(_reactDom2['default'].findDOMNode(renderedRestaurantList).parentNode);
	    });
	
	    it('fetches the data from the repository and sets the data on the component state', function (done) {
	        var data = [{ 'id': 1, 'name': 'Afuri' }];
	        var promiseResolver = { "then": function then(thenFunction) {
	                thenFunction(data);
	            } };
	        spyOn(_srcRestaurantRepository2['default'], 'fetchAll').and.returnValue(promiseResolver);
	
	        renderedRestaurantList = _reactAddonsTestUtils2['default'].renderIntoDocument(_react2['default'].createElement(_srcRestaurantList2['default'], null));
	
	        expect(_srcRestaurantRepository2['default'].fetchAll).toHaveBeenCalled();
	        setTimeout(function () {
	            expect(renderedRestaurantList.state.restaurants).toEqual(data);
	
	            var div = _reactAddonsTestUtils2['default'].findRenderedDOMComponentWithClass(renderedRestaurantList, 'restaurant-1');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RestaurantRepository = __webpack_require__(159);
	
	var _RestaurantRepository2 = _interopRequireDefault(_RestaurantRepository);
	...
	var RestaurantList = (function (_React$Component) {
	    ...
	    function RestaurantList(props) {
	        ...
	        _get(Object.getPrototypeOf(RestaurantList.prototype), 'constructor', this).call(this, props);
	    ...
	    _createClass(RestaurantList, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            _RestaurantRepository2['default'].fetchAll().then(function (data) {
	                _this.setState({ 'restaurants': data });
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var restaurants = this.state.restaurants.map(function (restaurant) {
	                return _react2['default'].createElement(
	                    'span',
	                    { className: 'restaurant-' + restaurant.id, key: restaurant.id },
	                    restaurant.name
	                );
	            });
	            return _react2['default'].createElement(
...
/***/ function(module, exports) {
	...
	var RestaurantRepository = {
	    fetchAll: function fetchAll() {
	        return fetch("http://localhost:8080/api/restaurants").then(function (r) {
	            return r.json();
	        });
	    }
	};
